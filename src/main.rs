...
fn get_curated_word(len:usize) -> Option<String> {
    ...
    let words = vec![
        ...
        "vertical", "wireless", "abbreviation", "application", "association",
        ...
        "complementary", "configuration", "conservation", "consultation",
        "coordination", "development", 
        "exaggeration", "implementation", "modification",
        "personification", "simplification", "specification", "unification",
        "accessibility", "accountability", "determination", "environment", 
        "percentage", "possibility", "publication",
        "registration", "replacement", "subscription", "temperature", "translation",
        "university", "volunteering", "adaptation", "advertising", "alternatives", "appreciation",
        "collaboration", "coordination", 
        "exaggeration", "implementation", "imagination",
        "modification", "personification", "simplification",
        "specification", "unification", "accessibility", "accountability", "administration",
        "determination", "environment", "examination", "implementation",
        "visualization", 
        "facilitation", "mathematics", "programming",
        "calligrapher", "constitution", "development", 
        "imagination", "modification", "personification", 
        "simplification", "specification", "unification", "eccentricity",
        ...
        "administration", "administrator", "agricultural", "approximately", "championship", "characteristic", "characterize",
        "circumstance", "communication", "comprehensive", "concentration", "congressional", "consciousness", "considerable",
        "consideration", "constitutional", "construction", "contemporary", "contribution", "controversial", "conventional",
        "conversation", "correspondent", "demonstration", "discrimination", "distribution", "dramatically", "entertainment",
        "environmental", "establishment", "extraordinary", "headquarters", "identification", "increasingly", "independence",
        "institutional", "intellectual", "intelligence", "international", "interpretation", "intervention", "introduction",
        "investigation", "investigator", "manufacturer", "manufacturing", "neighborhood", "nevertheless", "occasionally",
        "organization", "participation", "particularly", "photographer", "prescription", "presentation", "presidential",
        "professional", "recommendation", "relationship", "representation", "representative", "responsibility", "satisfaction",
        "significance", "significantly", "sophisticated", "specifically", "successfully", "surprisingly", "transformation",
        "transportation", "understanding", "unfortunately"
    ];
